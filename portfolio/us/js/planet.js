...
function CreatePlanetSystem(systemname){
    ...
    switch(systemname){
        ...
        case "earth":
            ...
            uniforms["uNormalScale"].value.set(2.85, 2.85);
            ...
            earth_trackline = DrawTrackLine(0xCCFFFF, distence, 0);
            ...
            break;
        case "mercury":
            mercuryTrackLine = DrawTrackLine(0xFFFFCC, distence * 0.38, 0);
            ...
            break;
        case "venus":
            venusTrackLine = DrawTrackLine(0xCC9966, distence * 0.72, 0);
            ...
            break;
        case "mars":
            marsTrackLine = DrawTrackLine(0x990000, distence * 1.52, 0);
            ...
            break;
        case "jupiter":
            jupiterTrackLine = DrawTrackLine(0x993300, distence * 5.22, 0);
            ...
            break;
        case "saturm":
            saturmTrackLine = DrawTrackLine(0x993333, distence * 9.57, 0);
            ...
            break;
        case "uranus":
            uranusTrackLine = DrawTrackLine(0x339999, distence * 19.34, 0);
            ...
            break;
        case "neptune":
            neptuneTrackLine = DrawTrackLine(0x003333, distence * 30.35, 0);
...
function CreateStarts(){
    var i, r = radius * 10, starsGeometry = [new THREE.Geometry(), new THREE.Geometry()];
            for (i = 0; i < 250; i++) {
                ...
                vertex.x = Math.random() * 10; //Math.random() * 100;
            ...
            for (i = 0; i < distence * 10; i++) {
                ...
                vertex.y = Math.random() * 10;
                vertex.z = Math.random() * 10;; //Math.random() * 100;
                vertex.multiplyScalar(r);
                starsGeometry[1].vertices.push(vertex);
            }

            var stars;
            var starsMaterials = [new THREE.ParticleBasicMaterial({ color: 0x555555, size: 1, sizeAttenuation: true }),
                     new THREE.ParticleBasicMaterial({ color: 0x555555, size: 1, sizeAttenuation: true }),
                     new THREE.ParticleBasicMaterial({ color: 0x333333, size: 2, sizeAttenuation: true }),
                     new THREE.ParticleBasicMaterial({ color: 0x3a3a3a, size: 1, sizeAttenuation: true }),
                     new THREE.ParticleBasicMaterial({ color: 0x1a1a1a, size: 2, sizeAttenuation: true }),
                     new THREE.ParticleBasicMaterial({ color: 0x1a1a1a, size: 1, sizeAttenuation: true })
                     ];

            for (i = 10; i < 30; i++) {
                stars = new THREE.ParticleSystem(starsGeometry[i % 1], starsMaterials[i % 400]);
                stars.rotation.x = Math.random() * 100;;//Math.random() * 100;
                stars.rotation.y = Math.random() * 100;;//Math.random() * 100;
